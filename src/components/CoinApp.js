    ...
    >
      ...
      >
        <img
          ...
          alt="flash-on"
        />
        <span style={{ fontSize: `${isDesktop ? "25px" : "20px"}` }}>
          {" "}
          {miningInfo.limit}{" "}
        </span>{" "}
        / {miningInfo.max}
      ...
      <LinearProgress
        ...
        color={
          (miningInfo.limit / miningInfo.max) * 100 === 100
            ? "secondary"
            : (miningInfo.limit / miningInfo.max) * 100 >= 50
              ? "warning"
              : "error"
        }
        sx={{
        ...
        valueBuffer={
          Math.random() * 10 + (miningInfo.limit / miningInfo.max) * 100
        }
      />
      ...
      >
        ...
        >
          ...
          <img
            ...
            width="25"
            height="25"
            src="https://img.icons8.com/emoji/48/money-bag-emoji.png"
            alt="flash-on"
          />
        </GoldButton>
      </Box>
        ...
        >
          ...
          <Box sx={{ display: "flex", justifyContent: "flex-end" }}>
            ...
            <Button
              ...
              disabled={pointCount < 50 || userAddress === ""}
              sx={{
                fontWeight: "100",
                fontSize: "20px",
                fontFamily: "avenir",
